...
public class AccountsController {
  ...
  public ResponseEntity<Object> transferAmount(@RequestBody @Valid TransferRequest transferRequest) {
    ...
    try {
      this.accountsService.tranferAmount(transferRequest.getFromAccountId(), transferRequest.getToAccountId(), transferRequest.getAmount());
    } catch (NotEnoughBalanceServiceException nebe) {
      return new ResponseEntity<>(nebe.getMessage(), HttpStatus.BAD_REQUEST);
    }
